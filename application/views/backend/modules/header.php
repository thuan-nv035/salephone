<header class="main-header" style="background: #FF9900 !important">
    <a href="<?php echo base_url()?>admin" class="logo" style="background: #FF9900 !important">
        <span class="logo-lg">Trang chủ</span>
    </a>
    <nav class="navbar navbar-static-top" style="height: 52px;background: #FF9900 !important">
