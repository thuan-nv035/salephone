					...
					<div class="box-body">
						...
						<div id="view">
							<form action="admin/orders/detail/<?php echo $id; ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
								...
								?>
								<h1 class="text-center" style="color: green;">CHI TIẾT ĐƠN HÀNG</h1>
								...
								<div class="table-responsive">
									<table class="table table-hover table-bordered">
										...
										<tbody>
											...
											<tr>
												<td colspan="6" class="text-right" style="border: none; color: green; font-size: 1.3em;">Thành tiền: <?php echo number_format($total+$price_ship-$coupon);?>₫</td>
											</tr>
