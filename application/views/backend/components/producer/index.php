												...
												<tr>
													...
													<td><?php echo $row['keyword'] ?></td>
														...
														if($user['role']==1){
															...
															<a class="btn btn-info" href="admin/producer/update/'.$row['id'].'" role = "button">
															Sửa
															</a>
															</td>';
														}
														...
														<td class="text-center">
															<a class="btn btn-primary" href="<?php echo base_url() ?>admin/producer/trash/<?php echo $row['id'] ?>" onclick="return confirm('Xác nhận xóa Nhà cung cấp này ?')" role = "button">
																Xóa
															</a>
														</td>
													</tr>
